...
export default function Opening() {
  return (
    <section className="relative isolate flex flex-col items-center justify-center min-h-screen overflow-hidden px-4 text-center">
      ...
      />
      <a href="https://opus.lumedot.com"
         target="_blank"
         rel="noopener noreferrer" 
         className="relative z-10 inline-flex items-center rounded-full border border-current/50 bg-current/5 px-4 py-2 text-xs font-medium uppercase tracking-wide backdrop-blur-sm shadow-sm transition-all hover:scale-105 hover:bg-fuchsia-600/50 cursor-pointer">
        Upload your first book on lumedot →
      </a>

      {/* Heading */}
      <h1 className="relative z-10 mt-6 max-w-4xl
