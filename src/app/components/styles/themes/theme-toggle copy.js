    ...
    <div className="w-full">
      <div
        className="
          ...
          hover:w-full hover:justify-start
          hover:border border-current/25 rounded-full p-[5px] transition-all duration-200
        "
      >
        {/* Light */}
        <button
          onClick={() => selectTheme("custom-light")}
          title="Light"
          className={`
            ${current === "custom-light"
              ? "inline-flex opacity-100"
              : "hidden group-hover:inline-flex opacity-75"}
        ...
        >
          ...
          <svg
            ...
            strokeWidth="2.25"
            stroke="currentColor"
            className="w-[20px] h-[20px] hover:text-teal-400"
          >
            <path
              strokeLinecap="round"
          ...
          >
            <path
              ...
              d="M9 17.25v1.007a3 3 0 0 1-.879 2.122
                 L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257
                 V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25
